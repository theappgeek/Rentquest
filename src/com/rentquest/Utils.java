...
public static String toBase64(byte[] byteArr)
{
 ...
 {
     char passwd[] ="angie".toCharArray();// {'a','n','g','i','e'};
        byte[] mp = makePasswordDigest("Amirr",passwd);
        
        
        System.out.println(toBase64(mp));
        
        String tr = toString(mp);
        
       
      boolean t =  MessageDigest.isEqual(mp,toByteArray(tr));
        //byte [] test = toByteArray("angie");
      System.out.println(t);
        
        //String rst =toString(makeBytes("angie".toCharArray()));
