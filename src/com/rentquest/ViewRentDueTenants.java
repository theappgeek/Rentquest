 ...
 * @author drenpro
 */
public class ViewRentDueTenants extends SwingWorker<ResultSet, Object> {
    ...
    public ViewRentDueTenants(String plotNo,JPanel rslPanel)
    {
    ...
    public ResultSet RentDueTenants(String plotNo)
    {
        ...
        String myQuery ="SELECT Tenants.First_Name, Tenants.Last_Name, Tenants.Tenant_ID, Tenants.Plot_no,"+
                ...
                "Tenants.Tenant_ID = PayRent.Tenant_ID AND DATE_SUB(CURDATE(),INTERVAL "+overdueDays+" DAY)"+
                " >= PayRent.Date_Of_Payment AND DATE_SUB(CURDATE(),INTERVAL "+maxDays+" DAY) <= PayRent.Date_Of_Payment"+
